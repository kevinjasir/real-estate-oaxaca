    ...
    <footer className="border-t border-[var(--border)] bg-white">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <h3 className="mb-4 text-xl font-bold text-[var(--foreground)]">
              Costa Oaxaca Real Estate
            </h3>
            <p className="mb-4 text-sm text-[var(--muted)]">
              Terrenos y residenciales verificados en Huatulco, Puerto Escondido
              y la costa de Oaxaca.
            </p>
        ...
        <div className="mt-12 border-t border-[var(--border)] pt-8">
          <div className="flex flex-col items-center justify-between gap-4 text-xs text-[var(--muted)] md:flex-row">
            <p>
              © {currentYear} Costa Oaxaca Real Estate. Todos los derechos
              reservados.
            </p>
